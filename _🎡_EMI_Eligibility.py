...
# Load trained model
model = joblib.load("best_classification_model_xgb.pkl")
...
if st.button("🔍 Predict Eligibility"):
    ...
    # Step 1: Create dataframe with all necessary columns
    input_data = pd.DataFrame([{
        ...
        "current_emi_amount": 2000,  # required column
    ...
    # Step 2: Guarantee ALL expected columns exist
    expected_cols = [
